...
def user_prompt():
  ...
  choice =  input(">").strip().lower()              #Zeileneingabe Whitespace entfernen und Kleinschreibung erzwingen
  for option in option_list:
    i+=1                                           #Entweder den Befehl gefunden oder übereinstimmung der Nummer der Option
